                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              _DetailLikeHeartButton(
                                active: _liked,
                                onTap: _toggleLike,
                              ),
                              const SizedBox(width: 8),
                              _DetailLikeCountButton(
                                count: _likes.length,
                                onTap: _showLikedBy,
                              ),
...
class _DetailLikeHeartButton extends StatelessWidget {
  const _DetailLikeHeartButton({required this.active, required this.onTap});
...
class _DetailLikeCountButton extends StatelessWidget {
  const _DetailLikeCountButton({required this.count, required this.onTap});
