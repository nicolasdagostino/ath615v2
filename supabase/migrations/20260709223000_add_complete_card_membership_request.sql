...
revoke all on function public.complete_card_membership_request(text, text, integer, text) from public;
revoke all on function public.complete_card_membership_request(text, text, integer, text) from anon;
grant execute on function public.complete_card_membership_request(text, text, integer, text) to service_role;
